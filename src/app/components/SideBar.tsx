...
export default function SocialSideBar() {
  ...
  return (
    <div
      ref={ref}
      className={`fixed right-6 top-1/2 -translate-y-1/2 z-50 transition-all duration-1000 ${
    ...
    >
      <div className="flex flex-col gap-4 bg-black/20 backdrop-blur-sm border border-white/10 rounded-full p-3">
        ...
        >
          <svg
            className="w-5 h-5 text-white group-hover:text-[oklch(0.51_0.19_28)] transition-colors duration-300"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {/* Facebook */}
        <a
          href="https://facebook.com/ariane.dj"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative p-3 rounded-full bg-black/40 border border-white/10 hover:border-[oklch(0.51_0.19_28)] transition-all duration-300 hover:bg-[oklch(0.51_0.19_28)]/10"
        >
